    ...
    <div class="row">
        <div class="col-lg-12 grid-margin stretch-card">
            <div class="card">
                ...
                <form class="forms-sample" action="{{ route('results.update', $result->id) }}" method="POST">
                    @csrf
                    @method('put')
                    <div class="row">
                        {{-- <div class="col-md-12">
                            <div class="form-group">
                                ...
                                <input type="text" name="{{ $result->match->id }}" id="match_id" class="form-control" value="{{ $result->match->name }}" disabled>
                            </div>
                        </div> --}}
                        <div class="col-md-12">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('home_goal') is-invalid @enderror" name="home_goal" id="home_goal" value="{{ $result->home_goal }}">
                                @error('home_goal')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" class="form-control @error('away_goal') is-invalid @enderror" name="away_goal" id="away_goal" value="{{ $result->away_goal }}">
                                @error('away_goal')
                                    <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                            </div>
